...
namespace MySelf.NET8.AuthenticationCenter.Controllers
{
    ...
    public class JWTController : ControllerBase
    {
        ...
        public string LoginWithRefresh([FromForm] string name, [FromForm] string password)
        {
            ...
            if ("傻逼".Equals(name, StringComparison.OrdinalIgnoreCase) && "123456".Equals(password))//应该数据库
            {
                CurrentUserModel currentUser = new CurrentUserModel()
                {
                    Id = 123,
